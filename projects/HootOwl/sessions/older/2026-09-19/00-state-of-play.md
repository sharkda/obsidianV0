...
>
> Carried forward from [[sessions/older/2026-09-18/00-state-of-play|2026-09-18]]. The IDs do not change — only **State** and **Moved** move, so an item cannot quietly disappear and "didn't we fix that?" has an answer.
...
Detail on today's work: [[sessions/older/2026-09-19/01-terms-of-use|01 — Terms of Use]] · [[sessions/older/2026-09-19/02-reviewer-scope-and-testing|02 — the California reviewer]].
